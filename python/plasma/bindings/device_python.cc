...
/* BINDTOOL_HEADER_FILE_HASH(97298d7dac21d5969dc94f4c30b3abc3)                     */
/***********************************************************************************/
...
void bind_device(py::module& m)
{
    ...
    py::class_<Device, std::shared_ptr<Device>> device_class(m, "Device");
    device_class.def(py::init<>(), D(Device, Device, 0));
    device_class.def(
        py::init<gr::plasma::Device const&>(), py::arg("arg0"), D(Device, Device, 1));
